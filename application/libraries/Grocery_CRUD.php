...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $default_language_path	= 'content/grocery_crud/languages';
	protected $default_config_path		= 'content/grocery_crud/config';
	protected $default_assets_path		= 'content/grocery_crud';
	...
	public function set_field_upload($field_name, $upload_dir = '', $allowed_file_types = '')
	{
		$upload_dir = !empty($upload_dir) && substr($upload_dir,-1,1) == '/'
						...
						: $upload_dir;
		$upload_dir = !empty($upload_dir) ? $upload_dir : 'content/uploads/grocery';
